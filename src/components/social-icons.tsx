...
export type SocialPlatform = "facebook" | "x" | "instagram" | "youtube" | "nabd" | "tiktok" | "threads" | "whatsapp";
...
export function SocialIcon({ platform, className = "h-4 w-4 fill-current" }: SocialIconProps) {
